...
import com.example.taskSample.HomeController.TaskItem;
...
public class TaskListDao {
    ...
    public void add(TaskItem taskItem) {
        // paramにはrecordで設定した値と実際にaddで入ってきた値をキーと値として紐づけてペアにしてinsert出来るようにする
        SqlParameterSource param = new BeanPropertySqlParameterSource(taskItem);
        // どこのデータベースのテーブルかをjdbcTemplateから取得している
